...
#SBATCH --mem=48000M
#SBATCH --array=1-198%2
#SBATCH --account=rpp-breden-ab
#SBATCH --output=/home/lgutierr/projects/rpp-breden-ab/ireceptor/SanityChecking/Sequence_Checks/output1_Sep2019/TSV_download_ipa1_seq%J.out
...
seq=/home/lgutierr/projects/rpp-breden-ab/ireceptor/SanityChecking/Sequence_Checks/SeqFiles1_Sep2019/
...
_id=`awk -F_, '{print $1}' _ids_ipa1 | head -$SLURM_ARRAY_TASK_ID | tail -1` 
...
python sequences.py ${_id} "nan,IG,TR,Homosap,F,ORF,less,nucleotides,are,than,aligned,(F),Musmus" ${seq} 'https://ipa1.ireceptor.org'
