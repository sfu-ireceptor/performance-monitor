...
#SBATCH --output=/home/lgutierr/projects/rpp-breden-ab/ireceptor/SanityChecking/Sequence_Checks/output4_Sep2019/TSV_download_ipa4_seq%J.out
...
seq=/home/lgutierr/projects/rpp-breden-ab/ireceptor/SanityChecking/Sequence_Checks/SeqFiles4_Sep2019/
...
_id=`awk -F_ '{print $1}' _ids_ipa4 | head -$SLURM_ARRAY_TASK_ID | tail -1` 
...
python sequences.py ${_id} "nan,IG,TR,Homosap,F,ORF,less,nucleotides,are,than,aligned,(F),Musmus" ${seq} 'https://ipa4.ireceptor.org'

python productive_test.py ${seq} ${_id}

deactivate

echo "End Python Sequence Check"
